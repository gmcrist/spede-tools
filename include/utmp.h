...
extern void         __updwtmp(__const char *__wtmp_file, __const struct utmp *__utmp);
...
extern int __getutid_r(__const struct utmp *__id, struct utmp *__buffer, struct utmp **__result);
extern int __getutline_r(__const struct utmp *__line, struct utmp *__buffer,
