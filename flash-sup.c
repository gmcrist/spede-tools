...
/* $Header: /export/home/aleks/Projects/Intel-159/Samples/00-Tools/flash/source/RCS/flash-sup.c,v 1.3 2001/02/04 01:03:31 aleks Exp $ */
...
/****************************************************************/
	...
	*p = '\0';
	...
	if( strstr(response, bad_resp1) || strstr(response, bad_resp2) ) {
